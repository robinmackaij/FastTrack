...
from demo_api.config import CONFIG
from demo_api.models.base import Detail
from demo_api.models.poem import NewPoem, Poem
from demo_api.storage.database import delete_poem, get_poem, get_poems, store_poem
